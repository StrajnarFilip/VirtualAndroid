...
"Path",
"${BaseAndroidPath}\platform-tools;${BaseAndroidPath}\cmdline-tools\latest\bin;$([System.Environment]::GetEnvironmentVariable("Path",[System.EnvironmentVariableTarget]::User))",
